                            ...
                            <!-- PAGE CONTENT BEGINS -->
                                <form class="form-horizontal" id="adduserform" role="form" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 订单名称<span style="color: red;">(*)</span> </label>

                                        <div class="col-sm-9">
                                            <input id="ordername" type="text" name="ordername"  placeholder="订单名称" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 客户名称<span style="color: red;">(*)</span> </label>

                                        <div class="col-sm-9">
                                            <input type="text" name="username"  placeholder="客户名称" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 客户电话<span style="color: red;">(*)</span> </label>

                                        <div class="col-sm-9">
                                            <input type="text" name="tel" placeholder="客户电话" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 客户联系方式 </label>

                                        <div class="col-sm-9">
                                            <input type="text" name="onlinelink" placeholder="客户电话" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 发货地址<span style="color: red;">(*)</span> </label>

                                        <div class="col-sm-9">
                                            <input type="text" name="address" placeholder="发货地址" class="col-xs-10 col-sm-5" />
                                        </div>
                                    </div>
                                    <div class="space-4"></div>

                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 供应商 </label>

                                        <div class="col-sm-9">
                                            <select name="suppid" class="form-control" style="width:41.6666%;">
                                                <?php if(is_array($rowSupp)): foreach($rowSupp as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["nickname"]); ?></option><?php endforeach; endif; ?>
                                            </select>
                                    ...
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-3">是否签订合同</label>

                                        <div class="col-sm-9">
                                            <label>
                                                <input name="agreement"  class="ace ace-switch" type="checkbox" />
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <!--<div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-3">锁定订单<span style="color: red;">(*)</span></label>
...
//                    var file = $("#id-input-file-3").val();
                    //var department= $(".form-control").find("option:selected").text();
                    var status = $("input[name='status']:checked").val();
                    var url = "<?php echo U('Order/addhandle');?>";
                    var options = { 
                        //target:        '#output1',   // target element(s) to be updated with server response 
                        beforeSubmit:  showRequest,  // pre-submit callback 
                        success: showResponse, // post-submit callback               
                        // other available options: 
                        url:"<?php echo U('Order/addhandle');?>",   // override for form's 'action' attribute
                    ...
                    function showResponse(data) {
                        ...
                        if(data.status){
                           ...
                           myshowmsg(data.msg);
                           $("#ordername").focus();
                           //window.location.href="<?php echo U('Order/edit');?>";
                           return false;
                        }
                        
                    }
                    function showRequest() {
                        if(ordername==''||username==''||tel==''||address==''){
