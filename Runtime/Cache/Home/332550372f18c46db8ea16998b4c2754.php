        ...
        <div class="page-content">
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        <i class="icon-double-angle-right"></i>
                        <a href="<?php echo U('Order/listorder',array('num'=>1));?>">订单管理</a>
                        <i class="icon-double-angle-right"></i>
                        设计要求列表<a href="javascript:history.back(-1)" style="color:red;">(返回上一页)</a>
                    </small>
                </h1>
            </div><!-- /.page-header -->
            <div class="row">
...
function showmsg(msg,id,mclick) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colNames:['ID','款式名称','款式数量','印刷要求','发货方式','交货日期','设计时间','备注打样','编辑'],
        colModel:[
            ...
            {name:'require', width:130,editable:true,align:'center',edittype:"textarea"},
        ...
        //altRows: true,
        //gridview:true, //加速显示
        editurl:"<?php echo U('Order/editAjaxDesign');?>", //编辑表格的url地址
        //toppager: true,
        sortname:"id",
        ...
        caption: "设计要求列表--------订单名：<b style='font-size: 16px;color: mediumpurple'>(<?php echo ($ordername); ?>)</b> ",
